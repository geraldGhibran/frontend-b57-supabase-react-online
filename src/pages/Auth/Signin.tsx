...
export const Signin = () => {
  ...
  useEffect(() => {
    // alert(import.meta.env.REACT_APP_SUPABASE_URL)
    if (session) {
      console.log(session);
    }
  }, []);
      ...
      <Stack spacing="8">
        ...
        >
          <HStack justify="center">
            <ColorModeSwitcher justifySelf="center" marginLeft={4} />
          </HStack>
                ...
                <Stack spacing="6">
                  ...
                  <Stack spacing="6">
                    <Button
                      ...
                      onClick={!authButtonState ? Register : Login}
                    >
                      {!authButtonState
                        ? loading || "Register"
                        : loading || "Sign in"}
